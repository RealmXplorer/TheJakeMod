...
public class GoldenShearsItem extends ShearsItem {
    public GoldenShearsItem(Properties pProperties){
        super(pProperties);
    }
    ...
    public float getDestroySpeed(ItemStack p_43084_, BlockState p_43085_) {
        if (!p_43085_.is(Blocks.COBWEB) && !p_43085_.is(BlockTags.LEAVES)) {
            if (p_43085_.is(BlockTags.WOOL)) {
                ...
                return !p_43085_.is(Blocks.VINE) && !p_43085_.is(Blocks.GLOW_LICHEN) ? super.getDestroySpeed(p_43084_, p_43085_) : 5.0F;
            }
        } else {
            return 22.0F;
        }
