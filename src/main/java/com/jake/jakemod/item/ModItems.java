...
public class ModItems {
    ...
    public static final RegistryObject<Item> BRIMSTONE = ITEMS.register("brimstone",
            () -> new BrimstoneItem(new Item.Properties().fireResistant()));

    public static final RegistryObject<Item> ABYSSON = ITEMS.register("abysson",
            () -> new AbyssonItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> SHULKER_BINDING = ITEMS.register("shulker_binding",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CHOCOLATE_BAR = ITEMS.register("chocolate_bar",
            () -> new Item(new Item.Properties().food(ModFoods.CHOCOLATE_BAR)));
    ...
    public static final RegistryObject<Item> SEASONED_STEAK = ITEMS.register("seasoned_steak",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_STEAK)));
    public static final RegistryObject<Item> SEASONED_CHICKEN = ITEMS.register("seasoned_chicken",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_CHICKEN)));
    public static final RegistryObject<Item> SEASONED_PORKCHOP = ITEMS.register("seasoned_porkchop",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_PORKCHOP)));
    public static final RegistryObject<Item> SEASONED_RABBIT = ITEMS.register("seasoned_rabbit",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_RABBIT)));
    public static final RegistryObject<Item> SEASONED_COD = ITEMS.register("seasoned_cod",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_COD)));
    public static final RegistryObject<Item> SEASONED_SALMON = ITEMS.register("seasoned_salmon",
            () -> new Item(new Item.Properties().food(ModFoods.SEASONED_SALMON)));

    public static final RegistryObject<Item> CURED_FLESH = ITEMS.register("cured_flesh",
            () -> new Item(new Item.Properties().food(ModFoods.CURED_FLESH)));
    ...
    public static final RegistryObject<Item> CANDY_CORN= ITEMS.register("candy_corn",
            () -> new Item(new Item.Properties().food(ModFoods.CANDY_CORN)));
    ...
    public static final RegistryObject<Item> GHAST_BERRY= ITEMS.register("ghast_berry",
            () -> new Item(new Item.Properties().food(ModFoods.GHAST_BERRY)));

    public static final RegistryObject<Item> ENDER_FRUIT= ITEMS.register("ender_fruit",
            () -> new Item(new Item.Properties().food(ModFoods.ENDER_FRUIT)));

    public static final RegistryObject<Item> PEPPERMINT_BARK= ITEMS.register("peppermint_bark",
            () -> new Item(new Item.Properties().food(ModFoods.PEPPERMINT_BARK)));
...
//GRANITE TOOLS
    ...
    public static final RegistryObject<Item> STEEL_AXE = ITEMS.register("steel_axe",
            () -> new AxeItem(ModTiers.STEEL, 5, -3.2f, new Item.Properties()));
    public static final RegistryObject<Item> STEEL_SHOVEL = ITEMS.register("steel_shovel",
            () -> new ShovelItem(ModTiers.STEEL, 1, -3f, new Item.Properties()));
    public static final RegistryObject<Item> STEEL_HOE = ITEMS.register("steel_hoe",
            () -> new HoeItem(ModTiers.STEEL, -1, -2f, new Item.Properties()));

    //HELLSTEEL TOOLS
    public static final RegistryObject<Item> HELLSTEEL_SWORD = ITEMS.register("hellsteel_sword",
            () -> new SwordItem(ModTiers.HELLSTEEL, 3, -2.4f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_PICKAXE = ITEMS.register("hellsteel_pickaxe",
            () -> new PickaxeItem(ModTiers.HELLSTEEL, 1, -2.8f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_AXE = ITEMS.register("hellsteel_axe",
            () -> new AxeItem(ModTiers.HELLSTEEL, 5, -3.2f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_SHOVEL = ITEMS.register("hellsteel_shovel",
            () -> new ShovelItem(ModTiers.HELLSTEEL, 1, -3f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_HOE = ITEMS.register("hellsteel_hoe",
            () -> new HoeItem(ModTiers.HELLSTEEL, -1, -2f, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> HELLSTEEL_HELMET = ITEMS.register("hellsteel_helmet",
            () -> new HellsteelArmorItem(ModArmorMaterials.HELLSTEEL, EquipmentSlot.HEAD, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_CHESTPLATE = ITEMS.register("hellsteel_chestplate",
            () -> new ArmorItem(ModArmorMaterials.HELLSTEEL, EquipmentSlot.CHEST, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_LEGGINGS = ITEMS.register("hellsteel_leggings",
            () -> new ArmorItem(ModArmorMaterials.HELLSTEEL, EquipmentSlot.LEGS, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> HELLSTEEL_BOOTS = ITEMS.register("hellsteel_boots",
            () -> new ArmorItem(ModArmorMaterials.HELLSTEEL, EquipmentSlot.FEET, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> GILDED_BLACKSTONE_HELMET = ITEMS.register("gilded_blackstone_helmet",
            () -> new GildedArmorItem(ModArmorMaterials.GILDED_BLACKSTONE, EquipmentSlot.HEAD, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_BLACKSTONE_CHESTPLATE = ITEMS.register("gilded_blackstone_chestplate",
            () -> new GildedArmorItem(ModArmorMaterials.GILDED_BLACKSTONE, EquipmentSlot.CHEST, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_BLACKSTONE_LEGGINGS = ITEMS.register("gilded_blackstone_leggings",
            () -> new GildedArmorItem(ModArmorMaterials.GILDED_BLACKSTONE, EquipmentSlot.LEGS, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_BLACKSTONE_BOOTS = ITEMS.register("gilded_blackstone_boots",
            () -> new GildedArmorItem(ModArmorMaterials.GILDED_BLACKSTONE, EquipmentSlot.FEET, new Item.Properties()));

    //CROWN
    public static final RegistryObject<Item> CROWN = ITEMS.register("crown",
            () -> new CrownItem(ModArmorMaterials.CROWN, EquipmentSlot.HEAD, new Item.Properties()));
