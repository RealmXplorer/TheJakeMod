...
//import net.minecraft.world.inventory.KilnBlockMenu;
//import net.minecraft.world.inventory.SmokerMenu;
//import net.minecraftforge.api.distmarker.Dist;
//import net.minecraftforge.api.distmarker.OnlyIn;
//
//@OnlyIn(Dist.CLIENT)
//public class KilnBlockScreen extends AbstractFurnaceScreen<SmokerMenu> {
//    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/smoker.png");
//
//    public KilnBlockScreen(SmokerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
